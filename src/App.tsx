      ...
      <section className="py-10 md:py-14 px-6 max-w-7xl mx-auto" id="소개">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div className="space-y-4" {...fadeInUp}>
            ...
            <h2 className="font-sans text-[32px] md:text-[40px] text-on-surface font-bold">울산국학원 소개</h2>
      ...
      <footer className="bg-[#F5F2E8] border-t border-stone-200 mt-auto">
        <div className="max-w-7xl mx-auto px-6 py-12 md:py-16 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          <div className="space-y-4">
            ...
            <div className="text-[16px] font-sans font-medium text-stone-500">사업자번호: 610-82-67406</div>
